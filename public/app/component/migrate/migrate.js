import $ from 'jquery';
import AnimatePoints from '../../graphic/AnimatePoint';
import AttackLine from '../../graphic/AttackLine';
import Config from '../../Config';
import Link from '../../graphic/Link';
import Map from '../../map/map';
import Symbol from '../../graphic/Symbol';
import Tail from '../../graphic/Tail';
...
export default class App extends Component {
    constructor(props) {
        ...
        this._drawMigrate = this._drawMigrate.bind(this);
    ...
    componentDidMount() {
        ...
        let migrate = getComputedStyle(this.refs.migrate);

        this.zr = zrender.init(this.refs.migrate, {
            width: migrate['width'],
            height: migrate['height']
        });
    ...
    render() {
        return (
            <div ref='map' className='map'>
                <div ref="migrate" className='migrate'>
                </div>
                {/*<div className='btn' onClick={this._btnClick}>button</div>*/}
            </div>
        );
    }
    ...
    _drawMigrate() {
        ...
        for (let index = 0; index < links.length; index++) {
            ...
            console.log(attackLine.displayName)
